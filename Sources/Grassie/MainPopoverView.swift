...
struct MainPopoverView: View {
    ...
    private var targetPopoverHeight: CGFloat {
        ...
        case .main:
            switch viewModel.selectedRange {
            case .oneMonth: return 545.0
            case .threeMonths: return 482.0
            case .sixMonths: return 445.0
            case .oneYear: return 420.0
            }
        case .settings:
            return 440.0
        case .stats:
    ...
    private var mainContentView: some View {
        VStack(spacing: 0) {
            ...
            // Content Area with Symmetrical Top & Bottom Padding
            VStack(spacing: 16) {
